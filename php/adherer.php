...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlUtilisateur = "INSERT INTO adherent (nom, prenom, date_naissance, adresse, adresse2, code_postal, ville, pays, telephone, email, profession, activite_actuelle, maladie, annee_souffrance, autres_maladies, connaissance_association)
        ...
        $sqlConnexion = "INSERT INTO utilisateur (utilisateur_id, pseudo, mot_de_passe)
